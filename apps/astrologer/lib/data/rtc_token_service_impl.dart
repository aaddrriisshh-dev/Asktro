...
/// Astrologer-side Agora token client. Mirrors the customer impl — the server
/// derives the astrologer's numeric uid (=2) from their role, so the returned
/// credentials are always distinct from the customer's.
