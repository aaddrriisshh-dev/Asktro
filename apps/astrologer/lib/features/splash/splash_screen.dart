...
/// Animated launch splash — matched to the customer app: a lavender celestial
/// sky where gold light scatters, stars twinkle, the zodiac wheel turns faintly,
/// then the Asktro wordmark rises in and the tagline settles beneath it. The
/// router holds here until auth resolves and the splash gate elapses.
...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  static const _zodiacWheel = 'assets/onboarding/zodiac_wheel.png';
  static const _logoWordmark = 'assets/onboarding/logo_wordmark.webp';
  ...
  // Slow, continuous revolve of the zodiac wheel — kept turning for the whole
  // (slightly longer) splash so the motion is enjoyable before login.
              ...
              children: [
                ...
                Center(
                  child: Transform.rotate(
                    ...
                    child: Opacity(
                      opacity: 0.11 * wheel,
                      child: Image.asset(_zodiacWheel, width: size.width * 1.15),
                    ),
                  ),
                ),
                // twinkling stars
                      ...
                      Opacity(
                        ...
                        child: Transform.translate(
                          ...
                          child: Transform.scale(
                            scale: 0.9 + 0.1 * logo,
                            child: Image.asset(_logoWordmark, width: math.min(size.width * 0.64, 300)),
                          ),
                        ),
                      ),
