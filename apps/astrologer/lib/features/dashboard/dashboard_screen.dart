...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Record every tab change into a history stack so system-back retraces the
    // tabs the user actually visited.
    ref.listen<int>(dashTabProvider, (prev, next) {
    ...
    return self.when(
      ...
      data: (astrologer) {
        ...
        // button would otherwise exit the app from any tab. Intercept it: go
          ...
          child: SkyScaffold(
            ...
            child: Stack(
              children: [
                ...
                // The incoming-call ring is now mounted app-wide (see app.dart),
                // so it fires on any screen — not only the Home tab.
