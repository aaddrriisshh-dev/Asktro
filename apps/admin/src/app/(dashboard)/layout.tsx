...
const NAV = [
  ...
  { href: '/chat-sessions', label: 'Chat Sessions', icon: I(<><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></>) },
  ...
  { href: '/recharge-orders', label: 'Recharge Orders', icon: I(<><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" /><path d="M3 6h18" /><path d="M16 10a4 4 0 0 1-8 0" /></>) },
  { href: '/referrals', label: 'Referrals', icon: I(<><circle cx="9" cy="7" r="3" /><path d="M2 21v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1" /><path d="M16 3.5a3 3 0 0 1 0 6M22 21v-1a4 4 0 0 0-3-3.87" /></>) },
  ...
  { href: '/account-deletions', label: 'Account Deletions', icon: I(<><path d="M3 6h18" /><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" /></>) },
  { href: '/payouts', label: 'Payouts', icon: I(<><rect x="3" y="5" width="18" height="14" rx="2" /><circle cx="16" cy="12" r="1.7" /></>) },
  { href: '/earnings-ledger', label: 'Earnings Ledger', icon: I(<><path d="M4 4h12a2 2 0 0 1 2 2v14H6a2 2 0 0 1-2-2z" /><path d="M8 8h6M8 12h6M8 16h4" /></>) },
  ...
  { href: '/ai-remedies', label: 'AI Remedy Questions', icon: I(<><path d="M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2z" /><path d="M9 21h6M10 17v4M14 17v4" /></>) },
