...
const ROLE_ROUTES: Record<AdminRole, string[] | '*'> = {
  super: '*',
  ops: ['/', '/users', '/astrologers', '/phone-sessions', '/video-sessions', '/plans', '/recharges', '/banners', '/blogs', '/mall', '/home-content', '/store', '/store-orders', '/store-content', '/coupons', '/broadcast', '/reports', '/kundali-downloads', '/cms', '/audit', '/payouts', '/pricing', '/support', '/moderation'],
