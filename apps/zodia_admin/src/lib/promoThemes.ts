...
export const PROMO_THEMES: PromoTheme[] = [
  ...
  { id: 'amethyst', name: 'Amethyst', bg: 'linear-gradient(140deg,#9576E8,#1e3269)', tx: '#FFFFFF', edge: 'rgba(255,255,255,.6)', base: '#6E4FD0', layout: 'wm', art: 'zwhite', op: 0.34, medal: '🎁' },
  ...
  { id: 'cosmicdusk', name: 'Cosmic Dusk', bg: 'linear-gradient(145deg,#2e4a8f,#C0567E,#E8873A)', tx: '#FFFFFF', edge: 'rgba(255,255,255,.55)', base: '#A85C9A', layout: 'wm', art: 'zwhite', op: 0.26, medal: '✨' },
  { id: 'golden', name: 'Golden Hour', bg: 'linear-gradient(140deg,#F6CB6A,#DE982F)', tx: '#3A2600', edge: 'rgba(58,38,0,.45)', base: '#EDAE49', accent: 'linear-gradient(120deg,#1e3269,#3A2A6E)', accentTx: '#FFFFFF', layout: 'split', art: 'gift', medal: '🎁' },
  { id: 'gift', name: 'Gilded Gift', bg: 'linear-gradient(135deg,#edf1f8,#E4D6FA)', tx: '#2A2350', edge: 'rgba(231,184,75,.8)', base: '#E7DAFA', layout: 'split', art: 'gift', medal: '🎁' },
  ...
  { id: 'saffron', name: 'Festive Saffron', bg: 'linear-gradient(150deg,#F2A73E,#C0473F)', tx: '#FFF7E6', edge: 'rgba(255,247,230,.65)', base: '#DE7A3E', accent: 'linear-gradient(120deg,#1e3269,#3A2A6E)', accentTx: '#FFFFFF', layout: 'split', art: 'mandala', medal: '🪔' },
  ...
  { id: 'sunburst', name: 'Sunburst', bg: 'radial-gradient(120% 120% at 30% 20%,#FFC94D,#E8873A)', tx: '#4A2400', edge: 'rgba(74,36,0,.4)', base: '#F0A043', accent: 'linear-gradient(120deg,#1e3269,#3A2A6E)', accentTx: '#FFFFFF', layout: 'split', art: 'gift', medal: '☀️' },
...
export const headlineColor = (t: PromoTheme): string =>
  luminance(t.base) < 0.45 ? '#e6eaf1' : t.tx;
