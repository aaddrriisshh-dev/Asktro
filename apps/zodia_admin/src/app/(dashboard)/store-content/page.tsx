...
/** Zodia Mall storefront content — testimonials, video reels and FAQs that
  ...
  return (
    <div>
      ...
      <p className="muted" style={{ margin: 0, fontSize: 13 }}>
        Testimonials, videos, FAQs &amp; product reviews shown on the Zodia Mall storefront. Updates go live in the app instantly — no rebuild.
      </p>
