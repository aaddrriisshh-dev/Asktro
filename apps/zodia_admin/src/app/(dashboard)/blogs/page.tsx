...
/** Blogs / "Zodia Journal" management — authored here, shown on the app home.
  ...
  return (
    <div>
      ...
      <p className="muted" style={{ margin: 0, fontSize: 13 }}>
        Write an article — it appears in the app’s “From the Zodia Journal” section on the home screen.
      </p>
