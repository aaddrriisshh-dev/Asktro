...
const DEFAULTS: TrustDoc = {
  ...
  items: [
    ...
    { icon: 'verified', title: 'Zodia Verified Astrologers', subtitle: 'Real experts with proven experience' },
    { icon: 'secure', title: 'Private & Confidential', subtitle: '100% secure consultations' },
  ],
};

/** Home Content → the "Why people trust Zodia" assurance band that renders on
 *  the home screen, right under the Zodia Mall store rail. Writes the single
  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      <p className="muted" style={{ margin: 0, fontSize: 13 }}>
        The two home-screen sections you can edit live — the Zodia Mall hero and the trust band below
      ...
      <p className="muted" style={{ margin: 0, fontSize: 13 }}>
        The &ldquo;Why people trust Zodia&rdquo; assurance strip, just below the Zodia Mall store rail.
      </p>
      ...
      <div className="card" style={{ padding: 16, display: 'grid', gap: 12 }}>
        <Field label="Heading">
          <input
            className="input"
            value={form.title}
            placeholder="Why People Trust Zodia"
...
/** The premium "Zodia Mall" hero at the top of the home store rail. Writes the
...
function StoreHeroEditor() {
  ...
  return (
    <section style={{ marginTop: 16 }}>
      <h2 style={{ fontSize: 18, margin: '0 0 4px' }}>Zodia Mall hero (store rail)</h2>
