...
/** Discounts — Zodia Mall coupon codes. Applied + re-validated server-side at
  ...
  return (
    <div>
      ...
      <p className="muted" style={{ margin: 0, fontSize: 13 }}>
        Coupon codes for Zodia Mall checkout. The discount is re-checked on the server when an order is placed.
      </p>
