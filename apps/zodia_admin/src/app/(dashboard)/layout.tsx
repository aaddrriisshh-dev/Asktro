...
// The Zodia Mall section has its OWN sidebar menu — a portal-inside-the-portal.
const MALL_NAV = [
...
const NAV = [
  { href: '/mall', label: 'Zodia Mall Dashboard', icon: STORE_ICON },
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <header className="topbar">
        ...
        <img className="topbar__emblem" src="/brand/emblem.png" alt="Zodia" />
        <span className="topbar__word">Zodia<span className="brand-tld">.in</span></span>
      </header>
      ...
      <aside className={`sidebar${collapsed ? ' sidebar--collapsed' : ''}${mobileOpen ? ' sidebar--open' : ''}${isMall ? ' sidebar--mall' : ''}`}>
        ...
        <div className="sidebar__brand">
          <div className="brand-row">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img className="brand-emblem" src="/brand/emblem.png" alt="Zodia" />
            <span className="brand-word">Zodia<span className="brand-tld">.in</span></span>
          </div>
          <span className="brand-tag">Guidance written in the stars</span>
        </div>
        <p className="sidebar__eyebrow">{isMall ? 'Zodia Mall' : 'Operations Console'}</p>
        <button
