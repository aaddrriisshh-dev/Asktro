    ...
    return Row(
      children: [
        Expanded(
          child: _CtaButton(
            onTap: _pay,
            gradient: const LinearGradient(colors: [Color(0xFF8A63D2), Color(0xFF5A3BBC)]),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF8A63D2), width: 1.5),
                  boxShadow: const [
                    BoxShadow(color: Color(0xFFC6B2EC), offset: Offset(0, 5)),
                    BoxShadow(color: Color(0x4C5E3FBE), blurRadius: 18, offset: Offset(0, 12)),
                  ],
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
