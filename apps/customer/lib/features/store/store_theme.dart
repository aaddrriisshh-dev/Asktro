...
/// Asktro Mall's "ghee-gold" identity — a warm, premium world that stands apart
/// from the app's lavender while staying cohesive with Asktro's serif-and-gold
/// taste. Used across the home rail and every store screen.
abstract final class Mall {
  // Ghee golds
  static const Color cream = Color(0xFFFDF4DD);
  static const Color light = Color(0xFFF7E6B4);
  static const Color gold = Color(0xFFEBC66E);
  static const Color deep = Color(0xFFD8A63E);
  static const Color goldInk = Color(0xFF9A6B12);
  static const Color goldLine = Color(0xFFE7C878);
  ...
  // App-cohesive
  static const Color navy = Color(0xFF2A2350);
  ...
  static const LinearGradient gheeGradient = LinearGradient(
    ...
    colors: [Color(0xFFFDF4DD), Color(0xFFF7E6B4), Color(0xFFEFCE85), Color(0xFFE7BE68)],
    stops: [0, .42, .78, 1],
  );
  ...
  static const LinearGradient navyButton = LinearGradient(
    ...
    colors: [Color(0xFF2A2350), Color(0xFF4A3A7A)],
  );
