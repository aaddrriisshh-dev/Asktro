...
/// A reusable "Report / Block" overflow menu backed by the moderation Cloud
/// Functions (`reportContent`, `blockUser`). Self-contained so it can drop into
/// any AppBar without touching the consultation service interface.
///
/// [targetId] is the user being reported/blocked, [targetLabel] a noun for the
/// copy ("astrologer"), and [consultationId] scopes a report when available.
