...
class ProfileTab extends ConsumerWidget {
        ...
        child: ListView(
          ...
          children: [
            ...
            _card([
              ...
              _row(Icons.info_outline_rounded, 'About ZODIA',
                  onTap: () => _push(context, const CmsViewerScreen(page: 'about', title: 'About ZODIA')),),
            ]),
  ...
  void _referral(BuildContext context, String code) {
    final shareText = code.isEmpty
        ? 'Join me on ZODIA — talk to expert astrologers. Download: $_kAppDownloadLink'
        : 'Join me on ZODIA — talk to expert astrologers! Use my code $code when you sign up, and we BOTH get ₹20 wallet credit after your first recharge.\n\nDownload: $_kAppDownloadLink';
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
          ...
          children: [
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                onPressed: () => Share.share(shareText, subject: 'Join me on ZODIA'),
