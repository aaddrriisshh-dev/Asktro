            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Your Zodia Mall orders will appear here.', style: TextStyle(color: Mall.warmGrey, fontSize: 13)),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Text('Visit Zodia Mall', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                    ),
                  ),
                ],
              ),
