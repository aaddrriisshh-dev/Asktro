/**
 * Publish the Privacy Policy + Terms of Service into the CMS (`cms/{page}`),
 * which the customer app renders under Settings. Editable later in the admin
 * portal without an app update.
 *
 *   node scripts/seed_legal.mjs            # dry run (prints what it will write)
 *   node scripts/seed_legal.mjs --yes      # actually write cms/privacy + cms/terms
 *
