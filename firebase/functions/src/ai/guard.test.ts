...
const FACTS = formatChartFacts({
  ...
  moonSignId: 3, // Cancer
  planets: [{ name: 'Saturn', signId: 9, house: 3, degree: 6.6, retrograde: true, navamsaSignId: 10, vargottama: false, saptamsaSignId: 4, dashamsaSignId: 7, aspectsHouses: [5, 9, 12] }],
